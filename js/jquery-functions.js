$("document").ready(function () {
  ...
  function skipToEnd(message) {
    ...
    const error =
      currentLanguage === "greek"
        ? "Λυπούμαστε αλλά δεν δικαιούστε να εκδόσετε άδεια χειριστή ταχυπλόου σκάφους!"
        : "We are sorry but you are not entitled to issue a speedboat operator's licence!";
  ...
  function retrieveAnswers() {
    ...
    if (allAnswers[3] === "2") {
      ...
      currentLanguage === "greek"
        ? setResult("Δικαιούστε την έκδοση άδειας χειριστή ταχυπλόου σκάφους.")
        : setResult("You are entitled to issue a speedboat operator's licence.");
  }
  ...
  function submitForm() {
    ...
    currentLanguage === "greek"
      ? $(".question-container").append(
          "<br /><br /><h5 class='answer'>Τα δικαιολογητικά που πρέπει να προσκομίσετε για την έκδοση άδειας χειριστή ταχυπλόου σκάφους είναι τα εξής:</h5><br />"
        )
      : $(".question-container").append(
          "<br /><br /><h5 class='answer'>The documents you need to provide in order to issue a speedboat operator's licence are the following:</h5><br />"
        );
  ...
  $("#nextQuestion").click(function () {
    if ($(".govgr-radios__input").is(":checked")) {
      ...
      if (currentQuestion === 0 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να έχετε συμπληρώσει το δέκατο όγδοο (18ο) έτος της ηλικίας σας.") : skipToEnd("You must be at least eighteen (18) years old");
      } else if (currentQuestion === 1 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να διαθέτετε Ελληνικό Αριθμό Φορολογικού Μητρώου (Α.Φ.Μ.).") : skipToEnd("You must have a Greek Tax Identification Number (A.F.M.).");
      } else if (currentQuestion === 2 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να γνωρίζετε κολύμβηση.") : skipToEnd("You must know how to swim.");
      } else {
